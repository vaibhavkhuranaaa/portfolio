  ...
  return <>
    ...
    <details className="shell technical-layer" open>
      ...
      <div className="technical-content">
        ...
        <section className="technical-section" aria-labelledby="data-title"><h3 id="data-title">Data boundary</h3><DataTable label="Data disclosure" headers={["Classification", "Source", "Permitted use", "Excluded data"]} rows={[[project.dataDisclosure?.classification, project.dataDisclosure?.source, project.dataDisclosure?.permittedUse, project.dataDisclosure?.excludedFields.join("; ")]]} /><p className="boundary-note">{project.disclaimer}</p></section>
